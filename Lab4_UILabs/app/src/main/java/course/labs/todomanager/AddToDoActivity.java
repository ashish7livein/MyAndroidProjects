	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//DONE TODO - Indicate result and finish
		...
		//DONE TODO - Set up OnClickListener for the Reset Button
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//DONE TODO - Reset data to default values
				mTitleText.setText("");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//DONE TODO - Get the current Priority
				Priority priority = getPriority();

				//DONE TODO - Get the current Status
				Status status = getStatus();

				//DONE  TODO - Get the current ToDoItem Title
				...
				ToDoItem.packageIntent(data, titleString, priority, status,
						fullDate);
				//Done // TODO - return data Intent and finish
